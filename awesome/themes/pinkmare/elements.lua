...
theme.tasklist_bg_normal  = colors.bg_darkest
theme.tasklist_fg_normal  = colors.fg_lightest
theme.tasklist_bg_focus   = colors.bg_light
theme.tasklist_fg_focus   = colors.fg_dark
...
theme.taglist_squares_sel = theme_assets.taglist_squares_sel(
    taglist_square_size, colors.fg_dark
)
